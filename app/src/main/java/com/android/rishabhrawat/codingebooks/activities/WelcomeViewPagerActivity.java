...
public class WelcomeViewPagerActivity extends AppCompatActivity {
   ...
   // private View lineView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        prefManager = new MySharedPreference(this);
       ...
       // lineView = findViewById(R.id.line_view);
        ...
        layouts = new int[]{
                R.layout.welcome_viewpager1,
                R.layout.welcome_viewpager2,
                R.layout.welcome_viewpager3};
    ...
    private void addBottomDots(int currentPage) {
        ...
        int colorsInactive = Color.DKGRAY;
    ...
    private void launchHomeScreen() {
         ...
         startActivity(new Intent(WelcomeViewPagerActivity.this, BottomNavigationActivity.class));
         finish();
    }
